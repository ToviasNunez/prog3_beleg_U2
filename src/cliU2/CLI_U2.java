...
public class CLI_U2 {
                ...
                case "create":
                    ...
                    switch (commands.get(1)) {
                        case "-p":
                            ...
                            System.out.println("producer was create name:" + commands.get(2) + ",last name" + commands.get(3));
                            break;
                        ...
                        case "-d":
                            ...
                            if (!darstellung_logic.getItemsList().isEmpty() && darstellung_logic.getItemsList().contains(items)) {
                                ...
                                System.out.println("the data is already inside , select other one");
                            } else
    ...
    public static void info() {
        ...
        System.out.println(" deleted:      -d    create a new producer o data media ");
        ...
        System.out.println("Examples:   create -d lav -> licensed audio video ");
